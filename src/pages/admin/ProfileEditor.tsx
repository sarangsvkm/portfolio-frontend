...
export default function ProfileEditor() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await resumeService.updateProfileAssets(
        profile.id ?? 1,
        {
          name: profile.name,
      ...
      showDialog('error', 'Profile Save Failed', 'Check the /api/profile PUT backend and credentials.');
    } finally {
      setSaving(false);
    }
  };
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">
            Manage your public identity, social links, and asset URLs from the updated API contract.
          </p>
        </div>
        <button
          onClick={handleSave}
      ...
      <div className="bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-2xl p-8 shadow-sm space-y-8">
        ...
        <div className="pt-8 border-t border-gray-100 dark:border-gray-800 space-y-6">
          <div className="flex justify-between items-center">
            ...
            <label className="inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold bg-gray-100 hover:bg-gray-200 dark:bg-gray-900 dark:hover:bg-gray-800 rounded-xl cursor-pointer transition-colors">
