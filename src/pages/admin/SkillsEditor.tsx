...
export default function SkillsEditor() {
  ...
  const handleAdd = () => {
    setSkills([{ name: '', level: 'Intermediate', category: '' }, ...skills]);
  };
      ...
      <div className="max-w-4xl space-y-6 pb-12">
        ...
        <div className="space-y-4">
          {skills.map((skill, index) => (
            <div key={skill.id || index} className="grid grid-cols-1 md:grid-cols-[1.5fr_1.5fr_1fr_auto] gap-4 items-end bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-2xl p-5 shadow-sm">
              ...
              <div className="space-y-2">
                ...
                <input type="text" placeholder="e.g. Languages" value={skill.category || ''} onChange={(e) => handleChange(index, 'category', e.target.value)} className="w-full px-4 py-3 border border-gray-300 dark:border-gray-700 rounded-xl bg-gray-50 dark:bg-gray-900 dark:text-white focus:ring-2 focus:ring-purple-500 outline-none transition-all" />
              </div>
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="w-full px-4 py-3 border border-gray-300 dark:border-gray-700 rounded-xl bg-gray-50 dark:bg-gray-900 dark:text-white focus:ring-2 focus:ring-purple-500 outline-none transition-all"
                >
